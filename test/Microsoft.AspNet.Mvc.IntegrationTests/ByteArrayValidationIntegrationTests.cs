...
{
    public class ByteArrayValidationIntegrationTests
    {
        ...
        [InlineData(true)]
        [InlineData(false)]
        public async Task BindProperty_WithData_GetsBound_ValidationIsSkipped(bool fallBackScenario)
        {
            // Arrange
            ...
            Assert.Equal(4, modelState.Keys.Count); // Should be only two keys. bug #2446
            ...
            Assert.Null(modelState[key].Value); // should be non null bug #2445.
        ...
        public async Task BindParameter_WithData_GetsBound_ValidationIsSkipped()
        {
            ...
            // The fourth key is due to bug #2446.
            ...
            Assert.Single(modelState.Keys, k => k == "CustomParameter[2]");
